...
from .hf_data_loader import hf_loader, get_required_skills, find_matching_jobs
...
def generate_learning_plan(
    ...
    logger.info(
        f"🚀 Generating AI learning plan for {len(selected_skills)} skills over {days} days"
    )
